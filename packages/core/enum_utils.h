...
#define FUNC_SIG
    ...
    namespace impl {
        ...
        constexpr std::string_view enum_to_string_helper(Enum value, [[maybe_unused]] std::integer_sequence<int32_t, I...> _) {
        ...
        template<class Enum, int32_t Offset, int32_t... I>
        [[nodiscard]] constexpr std::optional<Enum> enum_from_string(std::string_view name, [[maybe_unused]] std::integer_sequence<int32_t, I...> _) noexcept {
    ...
    template<class Enum, class U = std::underlying_type_t<std::decay_t<Enum>>>
    requires std::is_enum_v<std::decay_t<Enum>>
    constexpr std::optional<Enum> string_to_enum(std::string_view name) noexcept {
